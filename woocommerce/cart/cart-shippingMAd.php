...
<!--<tr class="woocommerce-shipping-totals shipping">-->
	<div class="col-6 text-left ">
		<span style="font-family: Montserrat; font-weight: bold; font-size: 0.6rem;">FRAIS D'ENVOI</span>
		<!--<th>--><?php //echo wp_kses_post( $package_name ); ?><!--</th>-->
	</div>
	<div class="col-6 text-right woocommerce-shipping-totals shipping" data-title="<?php echo esc_attr( $package_name ); ?>"> <!--  woocommerce-shipping-methods -->

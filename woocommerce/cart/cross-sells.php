...
<div class="cross-sells">
	...
	<?php
							...
							<h3 style="margin-left: 1.5rem; font-size: .8rem; font-family: Montserrat; color: #A78A3C; text-transform: uppercase;">Vous aimerez aussi</h3>
...
$variationPrice = [
            ...
            'max' => $product->get_variation_price('max')
       								...
       								//echo '<h7>' . apply_filters( 'woocommerce_cart_item_price', WC()->cart->$product->get_variation_price('max') ) . '</h7>';	

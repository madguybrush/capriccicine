					...
					<!--<tr class="woocommerce-cart-form__cart-item--> <?php //echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?><!--">-->
						...
						<div class="col-md-2 col-sm-6">
							...
							<div class="row">
								...
								<div class="col-md-12 col-sm-6 ctapanierenlevermobile">
			...
			<?php do_action( 'woocommerce_cart_contents' ); ?>
				...
				<td colspan="6" class="actions">-->
					<div class="row">
						...
						<div class="coupon col-lg-6 offset-lg-6">
							<label for="coupon_code">CODE PROMO : <?php //esc_html_e( 'Coupon:', 'understrap' ); ?></label>
							<input type="text" name="coupon_code" class="input-text form-control" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'understrap' ); ?><!-- "/>
							<button type="submit" class="ctapanierrafraichir" name="apply_coupon" value="APPLIQUER LE CODE PROMO<?php //esc_attr_e( 'Apply coupon', 'understrap' ); ?>">APPLIQUER LE CODE PROMO<?php //esc_attr_e( 'Apply coupon', 'understrap' ); ?></button>
...
<!--<button type="submit" class="ctapanierrafraichir" name="update_cart" value="Update cart" disabled="">RAFRAICHIR</button>-->

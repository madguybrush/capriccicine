...
<div class="col-sm-6 woocommerce-order-downloads">
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								case 'download-product':
									...
									break;
								case 'download-file':
									echo '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file alt"><button class="cta">' . esc_html( $download['download_name'] ) . '</button></a>';
									//echo '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file button cta alt">' . esc_html( $download['download_name'] ) . '</a>';
									break;

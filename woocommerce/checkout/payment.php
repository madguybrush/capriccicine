...
<div id="payment" class="woocommerce-checkout-payment">
	<?php if ( WC()->cart->needs_payment() ) : ?>
		<br / ><h3 id="order_review_heading">CHOISISSEZ UN MOYEN DE PAIEMENT</h3>
	...
	<div class="form-row place-order">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="cta btn btn-primary" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">' . esc_html( "Finaliser l'achat"/*$order_button_text*/ ) . '</button>' ); // @codingStandardsIgnoreLine ?>
